...
st.set_page_config(page_title="Interactive Data Visualization", layout="wide", initial_sidebar_state="collapsed")
...
with col1:
    ...
    age_group = st.slider("Select Age Group", 0, 9, 4)
...
with col2:
    ...
    # 2. Pie chart of Outcome for the selected disease
        ...
        st.subheader("Outcome Distribution for Selected Disease")
